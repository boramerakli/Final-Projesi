...
class Ui_dialog(object):
    ...
    def retranslateUi(self, dialog):
        ...
        self.pushButton_2.setText(_translate("dialog", "ONAYLA"))   # ++Arayüz için gerekli kütüphaneleri aktif ettik.
        self.init_ui()
        

    def init_ui(self):  # Basılan butonları takip eden fonksiyon.
            self.pushButton.clicked.connect(self.kamera)
...
if __name__ == "__main__":  # Kodun terminalden mi ide'den mi çalıştırıldığını kontrol ettik.
    import sys
